...
export const baseline_quotas_2026: BaselineQuota2026[] = [
  ...
  { player_name: "Chad Kelly", baseline_quota: 27 },
  ...
  { player_name: "Gary Neupauer", baseline_quota: 20 },
  { player_name: "Jack Fenwick", baseline_quota: 33 },
  ...
  { player_name: "Jeff Hodorowski", baseline_quota: 27 },
  ...
  { player_name: "Joe Rubbico", baseline_quota: 28 },
  ...
  { player_name: "Marty Behm", baseline_quota: 32 },
  ...
  { player_name: "Mike Mahasky", baseline_quota: 26 },
  { player_name: "Mike Wills", baseline_quota: 35 },
  { player_name: "Pat Murray", baseline_quota: 26 },
  { player_name: "Phil Lipski", baseline_quota: 22 },
  { player_name: "Rob Michaels", baseline_quota: 27 },
  { player_name: "Ron Prokrinchak", baseline_quota: 21 },
  { player_name: "Ryan Holthaus", baseline_quota: 17 },
  { player_name: "Scott Francis", baseline_quota: 31 },
