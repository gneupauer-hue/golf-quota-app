...
test("automatic playing groups move Avery Cole's group to Group 1", () => {
  const players = [
    ...
    { playerId: "avery-id", playerName: "Avery Cole", quota: 10, conflictIds: [], team: "D" as TeamCode }
  ];
  ...
  assert.equal(byPlayerId.get("avery-id")?.groupNumber, 1);
